...
- **Reader Interest is King**: When something is heavily covered, it is often due to large reader interest — not due to the importance of the event for you
	...
	- Journalists are under immense pressure by media owners and investors to provide content that is highly read/watched/shared and therefore most profitable (see this [hilarious video clip](https://www.youtube.com/watch?t=8m38s&v=bq2_wSsDwkQ))
...
(The rejoinder is that many unsexy businesses change the world after many years of hard work - even if they may look dumb at first)
  - Other technology industry examples:  "Facebook is bad" narrative in early 2018 leading to [every decision being suspect](https://twitter.com/josephfcox/status/981563571904622592), narrative around social media platforms around the Arab Spring
