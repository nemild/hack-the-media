...
- **Reader Interest is King**: When something is heavily covered, it is often due to large reader interest — not due to the importance of the event for you
	...
	- Journalists focus on "newsworthy" content, which they often (and mistakenly) believe is the content their audience *needs* [to make good decisions](https://www.reuters.com/article/rpb-adlertrump/covering-trump-the-reuters-way-idUSKBN15F276). Social networks use something similar called "relevant" content. Instead, newsworthy/relevant media is what their audience *wants* to consume (covering newsworthy content is tightly coupled with readership and profit in ad-supported business models).
	- Rather than thinking of news as mirror of what’s going on in the world, think of it as mirror of what people want to read/hear; the "invisible hand of the reader" dictates what content is created and how well it will be distributed
